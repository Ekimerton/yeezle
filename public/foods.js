const foods = [
  ...
  {
    name: "Seafood Pasta",
    ingredients: ["pasta", "seafood", "garlic", "tomatoes", "olives"],
  },
  {
    name: "Chicken Salad",
    ingredients: ["meat", "leafyGreens", "tomatoes", "onions", "cucumbers"],
  },
  {
    name: "Carrot and Mushroom Soup",
    ingredients: ["carrots", "mushrooms", "onions", "garlic", "herbs"],
  },
  {
    name: "Garlic Bread",
    ingredients: ["dough", "garlic", "butter", "cheese", "herbs"],
  },
  {
  ...
  },
  {
    ...
    ingredients: ["apples", "berries", "butter", "dough", "sweeteners"],
  },
  {
    name: "Chocolate Cake",
  ...
  },
  {
    ...
    ingredients: ["seafood", "peppers", "onions", "citrus", "spices"],
  },
  {
    name: "Greek Salad",
    ingredients: ["leafyGreens", "tomatoes", "cucumbers", "olives", "cheese"],
  },
  {
    name: "Spicy Chili",
    ingredients: ["meat", "beans", "onions", "tomatoes", "spices"],
  },
  {
    name: "Roast Chicken with Potatoes",
    ingredients: ["meat", "potatoes", "onions", "garlic", "herbs"],
  },
  {
    name: "Cream of Mushroom Soup",
    ingredients: ["mushrooms", "dairy", "onions", "herbs", "dough"],
  },
  {
    name: "Vinegar Coleslaw",
    ingredients: ["leafyGreens", "carrots", "onions", "vinegar", "sweeteners"],
  },
  {
    name: "Vegan Chocolate Mousse",
    ingredients: ["chocolate", "sweeteners", "coconutMilk", "tofu", "berries"],
  },
  {
    name: "Apple Pie",
